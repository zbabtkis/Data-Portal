var Page = Backbone.Model.extend({
	buildPage: function() {
		...
		for(object in cecDataModel.data) {
			...
			jQuery('#cec-data-list').append('<li data-filesystem-name="' + cecDataModel.data[object].filepath + '" class="cec-data-list-item ' + row + '">' + cecDataModel.data[object].filename + '</li>');
		}
	},
